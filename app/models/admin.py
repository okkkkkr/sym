...
class Product(BaseModel, TimestampMixin):
    ...
    cover_image_key = fields.CharField(max_length=500, description="封面图对象 Key，必须来自图片对象 Key 列表")
    image_keys = fields.JSONField(default=list, description="图片对象 Key 列表，包含封面图")
