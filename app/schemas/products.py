...
class BaseProduct(BaseModel):
    ...
    cover_image_key: str = Field(..., description="封面图对象 Key，必须来自图片对象 Key 列表")
    image_keys: list[str] = Field(default_factory=list, description="图片对象 Key 列表，包含封面图")
    ...
    @classmethod
    def normalize_cover_image_key(cls, value: str) -> str:
